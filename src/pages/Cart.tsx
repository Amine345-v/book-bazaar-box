    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-4 py-20 text-center">
          ...
          <Button className="font-body font-semibold" onClick={() => navigate("/browse")}>
            Start Shopping
          </Button>
        </main>
        <Footer />
        ...
        <div className="grid lg:grid-cols-[1fr_380px] gap-8">
          ...
          <div className="space-y-4">
            {items.map(({ book, quantity }) => (
              <div
                key={book.id}
                className="flex gap-4 bg-card rounded-xl p-4 shadow-book"
              >
                <img
                  src={book.cover}
                  alt={book.title}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-body font-medium text-sm w-6 text-center text-card-foreground">
                        {quantity}
                      </span>
                      <Button
                        variant="outline"
