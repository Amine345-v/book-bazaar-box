...
import { Star, ShoppingCart, ArrowLeft, BookOpen, Globe, FileText, Calendar } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <Button
          variant="ghost"
          className="font-body gap-2 mb-6 text-muted-foreground"
          onClick={() => navigate(-1)}
        >
        ...
        <div className="grid md:grid-cols-[350px_1fr] gap-10">
          ...
          <div className="flex flex-col">
            <span className="text-xs uppercase tracking-widest text-primary font-body font-semibold mb-2">
              {book.category}
            </span>
            ...
            <p className="font-body text-foreground/80 leading-relaxed mb-8 max-w-2xl">
              {book.description}
            </p>
        ...
        {relatedBooks.length > 0 && (
          <div className="mt-16">
            <BookSection
              ...
              subtitle={`More ${book.category} books`}
              books={relatedBooks}
            />
          </div>
        )}
